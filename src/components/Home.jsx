        ...
        <div className="mx-auto max-w-screen-xl px-4 py-8 sm:px-6 sm:py-12 lg:px-8">
          <header>
            ...
            <p className="mt-4 max-w-md text-gray-500">
              "Pilihan Kerudung Terbaik untuk Penampilan Sempurna! Tersedia
              Banyak Model, Siap Kirim!"
            </p>
          </header>
        ...
        <div class="mx-auto max-w-screen-xl px-4 pb-8 pt-16 sm:px-6 lg:px-8 lg:pt-24">
          <div class="text-center">
            ...
            <p class="mx-auto mt-4 max-w-sm text-gray-500">
              "Kerudung Berkualitas, Langsung dari Produsen! Pesan Sekarang,
              Stok Terbatas!"
            </p>

            <a
              href="#"
              class="mt-8 inline-block rounded-full border border-indigo-600 px-12 py-3 text-sm font-medium text-red-600   focus:outline-none focus:ring active:bg-indigo-500"
            >
              Chat Admin
            </a>
          </div>
